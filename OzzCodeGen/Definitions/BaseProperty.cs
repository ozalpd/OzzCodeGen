...
namespace OzzCodeGen.Definitions
{
    public abstract class BaseProperty : INotifyPropertyChanged
    {
        ...
        public static SimpleProperty CreatePropertyDefinition(string typeName, string propertyName, bool isStoreGenerated)
        {
            SimpleProperty property = (SimpleProperty)CreatePropertyDefinition(typeName, propertyName);
