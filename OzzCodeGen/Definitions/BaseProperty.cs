...
namespace OzzCodeGen.Definitions
{
    public abstract class BaseProperty : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Value is calculated and not stored in server or client
        /// </summary>
        ...
        //    {
        //        _transient = value;
        //        RaisePropertyChanged("Transient");
        //    }
        //}
        ...
        public override string ToString()
        {
            ...
            //return string.Format("{0} [{1}] {2}", Name, TypeName,
            //    (IsTypeNullable() ? "Null" : "Not Null"));
        }
        ...
        public static bool IsTypeNullable(BaseProperty p)
        {
            return p.IsTypeNullable();
        }
