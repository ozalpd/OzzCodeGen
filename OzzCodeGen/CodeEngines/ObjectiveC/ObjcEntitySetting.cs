...
namespace OzzCodeGen.CodeEngines.ObjectiveC
{
    public class ObjcEntitySetting : BaseEntitySetting
    {
        ...
        [XmlIgnore]
        public ObjcEngine CodeEngine { get; set; }
        ...
        public string ObjectiveCName
        {
            get
            {
                if (string.IsNullOrEmpty(_objcName))
                    _objcName = CodeEngine.ClassPrefix + Name;
                return _objcName;
            }
            set
            {
        ...
        public StorageEntitySetting GetStorageEntitySetting()
        {
            ...
            {
                _storageEntitySetting = CodeEngine
                                        .SqliteEngine
                                        .Entities
        ...
        public List<string> GetHeaderImports()
        {
            ...
            else if (CodeEngine.RenderConst)
            {
                imports.Add(string.Format("\"{0}\"", CodeEngine.ConstFile));
